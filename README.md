...
Repositório de provas antigas da Disciplina **Trabalho de Conclusão de Curso** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/trabalho-de-conclusao-de-curso.git`
...
`git clone git@github.com:compcederj/trabalho-de-conclusao-de-curso.git`
...
# Trabalho de Conclusão de Curso
Repositório de provas antingas da Disciplina **Trabalho de Conclusão de Curso** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
